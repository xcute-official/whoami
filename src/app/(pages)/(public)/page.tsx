...
const page = () => {
  return (
    <div className="flex items-center justify-center w-screen h-screen font-mono text-xs px-16">
      <div className="flex flex-col-reverse gap-16 md:flex-row w-full md:w-1/2 md:justify-between">
        ...
        <Image src={`/imgs/developer.png`} alt="image-error" height={200} width={200} />
      </div>
    </div>
  )
};
